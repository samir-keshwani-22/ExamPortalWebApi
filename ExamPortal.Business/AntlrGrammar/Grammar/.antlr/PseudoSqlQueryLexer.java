...
public class PseudoSqlQueryLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"STAR", "TIMEUNIT", "DATE", "IDENTIFIER", "VALUEIDENTIFIER", "INT", "DIGIT", 
			"IDENTIFIER_CHAR", "VALUE_CHAR", "WS", "INVALID"
		};
	}
	...
	public PseudoSqlQueryLexer(CharStream input) {
		super(input);
